...
[magnificently supported](http://ntoll.org/article/mu-pi) by the
...
[tutorial on how to report a bug](https://codewith.mu/en/howto/1.1/bugs)
in Mu. For other topics or help, please visit
[GitHub Discussions](https://github.com/mu-editor/mu/discussions).

We welcome contributions from anyone! Please see [contributing](contributing.md) for more
information.
