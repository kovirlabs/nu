...
[contributing](contributing.md) to learn about our expectations for submitting changes and
improvements.
...
The first thing to do is follow the instructions for [setup](setup.md).

You should read the explanation of [architecture](architecture.md) to learn how Mu fits
...
[list of currently open issues](https://github.com/mu-editor/mu/issues/),
...
beginner programmer? That's where [user-experience](user-experience.md) comes in and we would
