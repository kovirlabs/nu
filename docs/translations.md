...
* Make a translation of [Mu's website](https://codewith.mu/) (see the
  [website](website.md) guide for how to do this).

In both cases you'll be using assets found in the `mu/locale` directory.

Mu uses Python's standard [gettext](https://docs.python.org/3.6/library/i18n.html)
based internationalization API so we can make use of standard tools to help
translators, such as [babel](https://babel.pocoo.org/en/latest/) or
...
[creating a new issue in GitHub](https://github.com/mu-editor/mu/issues/new).
...
[setting up a development environment](setup.md) beforehand and,
from there,
...
* Those looking for a GUI based tool can try out [Poedit](https://poedit.net).
